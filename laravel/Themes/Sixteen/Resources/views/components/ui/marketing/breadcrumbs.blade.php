...
<nav class="flex justify-between border-t border-b dark:border-gray-800/60">
    <ol class="inline-flex mx-auto  items-center w-full py-2 px-8 mb-3 space-x-3 text-sm text-slate-800/70 dark:text-white/70 [&amp;_.active-breadcrumb]:text-neutral-500/80 sm:mb-0 ">
